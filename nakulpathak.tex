...
\vspace{2pt}
\item[-]Reduced quarterly maintenance time from a few hours to \textbf{5 minutes} by creating Bash scripts to shutdown and start up various services across over 20 virtual machines.
\vspace{2pt}
...
\vspace{2pt}
\item[-]Created and integrated open-source \href{https://github.com/activemerchant/payment_icons}{Payment Icons} gem across Shopify's codebase, providing a uniform way of adding payment icons into any Rails app.
\end{itemize}
\end{achievements}
