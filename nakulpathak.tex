...
% \item[-] \textit{Languages}: Ruby.
% \item[-] \textit{Tools}: Ruby on Rails.
...
% \item[-] \textit{Languages}: Ruby, Bash.
% \item[-] \textit{Tools}: Chef, Vagrant, Docker, Sensu, Elasticsearch.
...
% \item[-] \textit{Languages}: Ruby, Coffeescript, Sass, HTML (ERB), SQL.
% \item[-] \textit{Tools}: Ruby on Rails.
