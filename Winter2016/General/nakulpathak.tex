...
\\ - Used Test-Driven Development to 
...
\\ - Created \textit{\href{https://github.com/activemerchant/payment_icons}{Payment Icons}} open source library to render payment icons across Shopify.
\\ - 
\end{achievements}
...
\item[-]Used 3D geometry to control sideways motion using wrist movement
\end{itemize}
