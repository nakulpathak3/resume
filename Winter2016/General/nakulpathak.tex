...
\vspace{2pt}
\item[-]Use Chef and Docler to change system settings or add new software across multiple servers.
\vspace{2pt}
\item[-]Part of team responsible for migration of Chef to latest released version.
\end{itemize}
\vspace{2pt}
