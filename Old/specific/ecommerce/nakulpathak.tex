...
\item \textbf{Tools}: Ruby on Rails, Git, Coffeescript, Flask, jQuery, Google App Engine, Bootstrap, Bash
\item \textbf{Databases}: MySQL, Oracle SQL/PLSQL
\item \textbf{Miscellaneous}: TCP/IP protocols, HTTP requests, RESTful API development, Unix based systems.
\end{achievements}
